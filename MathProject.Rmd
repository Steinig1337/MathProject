...
selling_oct 
product <- read_xls("Data/Verkaufe_pro_Angebot_2019-07-01_2019-09-30.xls")
product_oct
...
## Combine the other month with the first

To get the whole data we have to combine all the different month.
...
We have to tidy up some columns which are totally useless.
...
Let's add the weather information for the selling days. Maybe there is a correlation between bad weather and bad selling days.
